...
uber_df <- read_csv("uber-raw-data-jun14.csv", na = ".")
...
# saves objects to rds files for shiny app to load in server.R
saveRDS(merged, "df_shapefile")
saveRDS(df_uber_date, "df_date")
saveRDS(df_uber_time, "df_time")
